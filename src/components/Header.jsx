...
const Header = () => {
  ...
  return (
    <nav className="flex items-center justify-between w-full relative  boxShadow rounded-full px-[10px] py-[8px] font-montserrat">
      <Link to="/">
        <img src={logo} alt="logo" className="w-32 object-cover" />
      </Link>
      <ul className="items-center gap-[20px] text-2xl text-[#424242] lg:flex hidden font-semibold">
        <NavLink to="/">
      ...
      <div className="items-center gap-[10px] flex">
        <Link to="/register">
          <button className="py-[7px] text-lg px-[16px] rounded-full capitalize bg-[#3B9DF8] text-white hover:bg-blue-400 transition-all duration-300 sm:flex hidden">
            Register
          </button>
        </Link>
