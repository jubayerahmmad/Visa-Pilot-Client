  ...
  return (
    <div className="w-full bg-blue-200 dark:bg-slate-800">
      <nav className="flex items-center justify-between relative lg:w-10/12 mx-auto boxShadow font-montserrat">
        ...
        <ul className="items-center gap-8 text-xl  xl:flex hidden font-semibold dark:text-white">
          <NavLink to="/">
          ...
          <NavLink to="/faq">
            <li className="hover:text-[#3B9DF8]">FAQs</li>
          </NavLink>
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  <NavLink to="/myAddedVisas">
                    <li className="hover:text-[#3B9DF8]">
                      <button>My Visa</button>
                    </li>
                  </NavLink>
